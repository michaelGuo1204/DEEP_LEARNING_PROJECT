...
from numpy import random,load,array,append,savez
import os.path
import datetime
...
class Autoencoder_Model:
    def __init__(self,ifAttention=False):
        ...
        self._train_epoch=100 #Set train epoch 100
        self._batch_size=1
        if ifAttention:
    ...
    def attentionModel(self):
        ...
        decoded = LSTM(self._features)(decoded)
    ...
    def trainModel(self,X_train,Y_train,X_valid,Y_valid):
        ...
        print("=========Begin=======")
        self._autoencoder_model.fit(X_train,X_train,epochs=self._train_epoch,verbose=1,validation_data=(X_valid,X_valid),callbacks=[cp_callback,tb_callback])
